...
@jakarta.xml.bind.annotation.XmlType(name = "sdtLotacaoV2", namespace ="SeletivoSEPLAG")
...
public final  class SdtsdtLotacaoV2_RESTInterface extends GxGenericCollectionItem<SdtsdtLotacaoV2>
{
   ...
   {
      return GXutil.dateToCharREST( sdt.getgxTv_SdtsdtLotacaoV2_Lot_data_lotacao()) ;
   }

   @JsonProperty("lot_data_lotacao")
   public void setgxTv_SdtsdtLotacaoV2_Lot_data_lotacao(  String Value )
   {
      sdt.setgxTv_SdtsdtLotacaoV2_Lot_data_lotacao( GXutil.charToDateREST( Value) );
   }
   ...
   {
      return GXutil.dateToCharREST( sdt.getgxTv_SdtsdtLotacaoV2_Lot_data_remocao()) ;
   }

   @JsonProperty("lot_data_remocao")
   public void setgxTv_SdtsdtLotacaoV2_Lot_data_remocao(  String Value )
   {
      sdt.setgxTv_SdtsdtLotacaoV2_Lot_data_remocao( GXutil.charToDateREST( Value) );
   }
