...
public final  class SdtsdtListaCidade extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("cid_nome", GXutil.rtrim( gxTv_SdtsdtListaCidade_Cid_nome));
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("cid_uf", GXutil.rtrim( gxTv_SdtsdtListaCidade_Cid_uf));
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
   ...
   {
      gxTv_SdtsdtListaCidade_N = (byte)(1) ;
   ...
   public byte isNull( )
   {
      return gxTv_SdtsdtListaCidade_N ;
   }
