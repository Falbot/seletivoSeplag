...
@jakarta.xml.bind.annotation.XmlType(name = "crud_endereco_create__post_RESTInterfaceOUT", namespace ="http://tempuri.org/")
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class crud_endereco_create__post_RESTInterfaceOUT
{
   short AV14RetornoPK;
   @JsonProperty("RetornoPK")
   public short getRetornoPK( )
   {
      return AV14RetornoPK ;
   }
