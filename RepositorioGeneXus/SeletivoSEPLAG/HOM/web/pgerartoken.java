...
public final  class pgerartoken extends GXProcedure
{
   ...
   private void privateExecute( )
   {
      ...
      {
         System.out.println( "Chegou Usuário e Senha" );
         ...
         System.out.println( "Toke Gerado - "+AV16Token );
         System.out.println( GXutil.booltostr( AV20JWTCreator.haserror()) );
         ...
         else
         {
            ...
            System.out.println( "Base 64 token: "+AV16Token );
         }
      }
      cleanup();
   }
