...
public final  class pessoa_impl extends GXDataArea
{
   ...
   public void drawControls( )
   {
      ...
      GxWebStd.gx_single_line_edit( httpContext, edtpes_id_Internalname, GXutil.ltrim( localUtil.ntoc( A7pes_id, (byte)(4), (byte)(0), ",", "")), GXutil.ltrim( ((edtpes_id_Enabled!=0) ? localUtil.format( DecimalUtil.doubleToDec(A7pes_id), "ZZZ9") : localUtil.format( DecimalUtil.doubleToDec(A7pes_id), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtpes_id_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtpes_id_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_pessoa.htm");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      ClassString = "Attribute" ;
      StyleString = "" ;
      GxWebStd.gx_html_textarea( httpContext, edtpes_nome_Internalname, A8pes_nome, "", TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,39);\"", (short)(0), 1, edtpes_nome_Enabled, 0, 80, "chr", 3, "row", StyleString, ClassString, "", "", "200", -1, 0, "", "", (byte)(-1), true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_pessoa.htm");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 FormCell", "left", "top", "", "", "div");
      /* Div Control */
      GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtpes_sexo_Internalname+"\"", "", "div");
      /* Attribute/Variable Label */
      ...
      GxWebStd.gx_single_line_edit( httpContext, edtpes_sexo_Internalname, A10pes_sexo, GXutil.rtrim( localUtil.format( A10pes_sexo, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,49);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtpes_sexo_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtpes_sexo_Enabled, 0, "text", "", 9, "chr", 1, "row", 9, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_pessoa.htm");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 FormCell", "left", "top", "", "", "div");
      /* Div Control */
      GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtpes_mae_Internalname+"\"", "", "div");
      /* Attribute/Variable Label */
      ...
      ClassString = "Attribute" ;
      StyleString = "" ;
      GxWebStd.gx_html_textarea( httpContext, edtpes_mae_Internalname, A11pes_mae, "", TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,54);\"", (short)(0), 1, edtpes_mae_Enabled, 0, 80, "chr", 3, "row", StyleString, ClassString, "", "", "200", -1, 0, "", "", (byte)(-1), true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_pessoa.htm");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 FormCell", "left", "top", "", "", "div");
      /* Div Control */
      GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtpes_pai_Internalname+"\"", "", "div");
      /* Attribute/Variable Label */
      ...
      ClassString = "Attribute" ;
      StyleString = "" ;
      GxWebStd.gx_html_textarea( httpContext, edtpes_pai_Internalname, A12pes_pai, "", TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,59);\"", (short)(0), 1, edtpes_pai_Enabled, 0, 80, "chr", 3, "row", StyleString, ClassString, "", "", "200", -1, 0, "", "", (byte)(-1), true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_pessoa.htm");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 FormCell", "left", "top", "", "", "div");
      /* Div Control */
      GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtpes_idade_Internalname+"\"", "", "div");
      /* Attribute/Variable Label */
      GxWebStd.gx_label_element( httpContext, edtpes_idade_Internalname, "pes_idade", "col-sm-3 AttributeLabel", 1, true, "");
      /* Div Control */
      GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
      /* Single line edit */
      GxWebStd.gx_single_line_edit( httpContext, edtpes_idade_Internalname, GXutil.ltrim( localUtil.ntoc( A34pes_idade, (byte)(4), (byte)(0), ",", "")), GXutil.ltrim( ((edtpes_idade_Enabled!=0) ? localUtil.format( DecimalUtil.doubleToDec(A34pes_idade), "ZZZ9") : localUtil.format( DecimalUtil.doubleToDec(A34pes_idade), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtpes_idade_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtpes_idade_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_pessoa.htm");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20254215303238", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20254215303247", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("pessoa.js", "?20254215303248", false, true);
