...
public final  class crud_endereco extends GXProcedure
{
   ...
   public void gxep_create__post( SdtsdtEndereco in_AV11DadosEndereco ,
   ...
   public void gxep_update__put( SdtsdtListaEndereco in_AV13ListaEndereco ,
                                 GXBaseCollection<com.genexus.SdtMessages_Message> [] arr_AV7Messages )
   {
   ...
   public void gxep_delete__delete( short in_AV9codgEndereco ,
                                    GXBaseCollection<com.genexus.SdtMessages_Message> [] arr_AV7Messages )
   {
      this.AV9codgEndereco = in_AV9codgEndereco;
      initialize();
