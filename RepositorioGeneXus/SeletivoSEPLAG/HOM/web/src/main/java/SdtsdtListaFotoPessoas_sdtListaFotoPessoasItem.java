...
public final  class SdtsdtListaFotoPessoas_sdtListaFotoPessoasItem extends GxUserType
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("pes_nome", gxTv_SdtsdtListaFotoPessoas_sdtListaFotoPessoasItem_Pes_nome);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
