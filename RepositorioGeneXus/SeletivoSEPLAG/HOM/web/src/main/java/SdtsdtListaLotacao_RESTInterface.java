...
@jakarta.xml.bind.annotation.XmlType(name = "sdtListaLotacao", namespace ="SeletivoSEPLAG", propOrder={"lot_id", "pes_id", "pes_nome", "unid_id", "unid_nome", "unid_sigla", "lot_data_lotacao", "lot_data_remocao", "lot_portaria"})
