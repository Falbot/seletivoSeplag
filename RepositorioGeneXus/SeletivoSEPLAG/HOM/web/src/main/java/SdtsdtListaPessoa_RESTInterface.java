...
@jakarta.xml.bind.annotation.XmlType(name = "sdtListaPessoa", namespace ="SeletivoSEPLAG", propOrder={"pes_id", "pes_nome", "pes_data_nascimento", "pes_sexo", "pes_mae", "pes_pai"})
