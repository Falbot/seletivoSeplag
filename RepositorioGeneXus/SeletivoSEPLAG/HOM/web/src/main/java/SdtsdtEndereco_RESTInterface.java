...
@jakarta.xml.bind.annotation.XmlType(name = "sdtEndereco", namespace ="SeletivoSEPLAG", propOrder={"end_tipo_logradouro", "end_logradouro", "end_numero", "end_bairro", "cid_id"})
