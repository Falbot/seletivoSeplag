...
public final  class SdtsdtLotacaoV2 extends GxUserType
{
                         ...
                         String sName )
   {
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            {
               gxTv_SdtsdtLotacaoV2_Lot_data_lotacao = oReader.getValue() ;
               readElement = true ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
            ...
            {
               gxTv_SdtsdtLotacaoV2_Lot_data_remocao = oReader.getValue() ;
               readElement = true ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("lot_data_lotacao", gxTv_SdtsdtLotacaoV2_Lot_data_lotacao);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("lot_data_remocao", gxTv_SdtsdtLotacaoV2_Lot_data_remocao);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("lot_portaria", gxTv_SdtsdtLotacaoV2_Lot_portaria);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
                       ...
                       boolean includeNonInitialized )
   {
      ...
      AddObjectProperty("lot_data_lotacao", gxTv_SdtsdtLotacaoV2_Lot_data_lotacao, false, false);
      AddObjectProperty("lot_data_remocao", gxTv_SdtsdtLotacaoV2_Lot_data_remocao, false, false);
