...
public final  class Sdtlotacao extends GxSilentTrnSdt
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("pes_nome", gxTv_Sdtlotacao_Pes_nome);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      ...
      oWriter.writeElement("unid_nome", gxTv_Sdtlotacao_Unid_nome);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("unid_sigla", gxTv_Sdtlotacao_Unid_sigla);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      ...
      if ( sIncludeState )
      {
         ...
         oWriter.writeElement("pes_nome_Z", gxTv_Sdtlotacao_Pes_nome_Z);
         if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
         {
            oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
         }
         ...
         oWriter.writeElement("unid_nome_Z", gxTv_Sdtlotacao_Unid_nome_Z);
         if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
         {
            oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
         }
         oWriter.writeElement("unid_sigla_Z", gxTv_Sdtlotacao_Unid_sigla_Z);
         if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
         {
            oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
         }
