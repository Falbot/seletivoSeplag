...
public final  class SdtsdtEnderecoLotacaoEfetivo_sdtEnderecoLotacaoEfetivoItem extends GxUserType
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("end_tipo_logradouro", gxTv_SdtsdtEnderecoLotacaoEfetivo_sdtEnderecoLotacaoEfetivoItem_End_tipo_logradouro);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("end_logradouro", gxTv_SdtsdtEnderecoLotacaoEfetivo_sdtEnderecoLotacaoEfetivoItem_End_logradouro);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      ...
      oWriter.writeElement("end_bairro", gxTv_SdtsdtEnderecoLotacaoEfetivo_sdtEnderecoLotacaoEfetivoItem_End_bairro);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("cid_nome", gxTv_SdtsdtEnderecoLotacaoEfetivo_sdtEnderecoLotacaoEfetivoItem_Cid_nome);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("cid_uf", gxTv_SdtsdtEnderecoLotacaoEfetivo_sdtEnderecoLotacaoEfetivoItem_Cid_uf);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("pes_nome", gxTv_SdtsdtEnderecoLotacaoEfetivo_sdtEnderecoLotacaoEfetivoItem_Pes_nome);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("unid_nome", gxTv_SdtsdtEnderecoLotacaoEfetivo_sdtEnderecoLotacaoEfetivoItem_Unid_nome);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("unid_sigla", gxTv_SdtsdtEnderecoLotacaoEfetivo_sdtEnderecoLotacaoEfetivoItem_Unid_sigla);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
