...
public final  class crud_unidade_services_rest extends GxRestService
{
   ...
   public jakarta.ws.rs.core.Response gxep_create( crud_unidade_create_RESTInterfaceIN gxep_createparm ) throws Exception
   {
      super.init( "POST" );
      permissionPrefix = "";
      ...
      AV6DadosUnidade = (SdtsdtUnidade)gxep_createparm.getDadosUnidade().getSdt();
      ...
      try
      {
         ...
         worker.gxep_create(AV6DadosUnidade,AV15RetornoPK,AV7Messages );
         crud_unidade_create_RESTInterfaceOUT data = new crud_unidade_create_RESTInterfaceOUT();
   ...
   @jakarta.ws.rs.Consumes({jakarta.ws.rs.core.MediaType.APPLICATION_JSON})
   @jakarta.ws.rs.Produces({jakarta.ws.rs.core.MediaType.APPLICATION_JSON + ";charset=UTF-8"})
   public jakarta.ws.rs.core.Response gxep_update( crud_unidade_update_RESTInterfaceIN gxep_updateparm ) throws Exception
   {
      super.init( "PUT" );
      permissionPrefix = "";
      if ( ! isAuthenticated(myServletRequestWrapper) )
      ...
      AV12ListaUnidade = (SdtsdtListaUnidade)gxep_updateparm.getListaUnidade().getSdt();
      @SuppressWarnings("unchecked")
      GXBaseCollection<com.genexus.SdtMessages_Message> [] AV7Messages = new GXBaseCollection[] { new GXBaseCollection<com.genexus.SdtMessages_Message>() };
      try
      {
         crud_unidade worker = new crud_unidade(remoteHandle, context);
         worker.gxep_update(AV12ListaUnidade,AV7Messages );
         crud_unidade_update_RESTInterfaceOUT data = new crud_unidade_update_RESTInterfaceOUT();
         data.setMessages(SdtMessages_Message_RESTInterfacefromGXObjectCollection(AV7Messages[0]));
         builder = Response.okWrapped(data);
         if ( worker.getrestcode() != 0 )
         {
   ...
   @jakarta.ws.rs.Produces({jakarta.ws.rs.core.MediaType.APPLICATION_JSON + ";charset=UTF-8"})
   public jakarta.ws.rs.core.Response gxep_delete( @jakarta.ws.rs.QueryParam("Codgunidade") @jakarta.ws.rs.DefaultValue("") String sAV10codgUnidade ) throws Exception
   {
      super.init( "DELETE" );
      permissionPrefix = "";
      if ( ! isAuthenticated(myServletRequestWrapper) )
      ...
      {
         crud_unidade worker = new crud_unidade(remoteHandle, context);
         worker.gxep_delete(AV10codgUnidade,AV7Messages );
         crud_unidade_delete_RESTInterfaceOUT data = new crud_unidade_delete_RESTInterfaceOUT();
         data.setMessages(SdtMessages_Message_RESTInterfacefromGXObjectCollection(AV7Messages[0]));
         builder = Response.okWrapped(data);
         if ( worker.getrestcode() != 0 )
         {
   ...
   @jakarta.ws.rs.DELETE
   @jakarta.ws.rs.Produces({jakarta.ws.rs.core.MediaType.APPLICATION_JSON + ";charset=UTF-8"})
   public jakarta.ws.rs.core.Response gxep_delete_endereco( @jakarta.ws.rs.QueryParam("Codgunidade") @jakarta.ws.rs.DefaultValue("") String sAV10codgUnidade ,
                                                            @jakarta.ws.rs.QueryParam("Codendereco") @jakarta.ws.rs.DefaultValue("") String sAV16codEndereco ) throws Exception
   {
      ...
      {
         crud_unidade worker = new crud_unidade(remoteHandle, context);
         worker.gxep_delete_endereco(AV10codgUnidade,AV16codEndereco,AV7Messages );
         crud_unidade_delete_endereco_RESTInterfaceOUT data = new crud_unidade_delete_endereco_RESTInterfaceOUT();
         data.setMessages(SdtMessages_Message_RESTInterfacefromGXObjectCollection(AV7Messages[0]));
         builder = Response.okWrapped(data);
         if ( worker.getrestcode() != 0 )
         {
