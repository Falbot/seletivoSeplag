...
{
   public static  class Gxep_create_servidorefetivoparm
   {
   ...
   public jakarta.ws.rs.core.Response gxep_create_servidorefetivo( crud_servidor_create_servidorefetivo_RESTInterfaceIN gxep_create_servidorefetivoparm ) throws Exception
   {
      super.init( "POST" );
      permissionPrefix = "";
      ...
      AV7DadosServidor = (SdtsdtServidor)gxep_create_servidorefetivoparm.getDadosServidor().getSdt();
      String AV9NumeroMatricula;
      AV9NumeroMatricula = gxep_create_servidorefetivoparm.getNumeroMatricula() ;
      ...
      try
      {
         ...
         worker.gxep_create_servidorefetivo(AV7DadosServidor,AV9NumeroMatricula,AV6Messages );
         crud_servidor_create_servidorefetivo_RESTInterfaceOUT data = new crud_servidor_create_servidorefetivo_RESTInterfaceOUT();
   ...
   @jakarta.ws.rs.Produces({jakarta.ws.rs.core.MediaType.APPLICATION_JSON + ";charset=UTF-8"})
   public jakarta.ws.rs.core.Response GetOptionsCreate_ServidorEfetivo( ) throws Exception
   {
      super.init( "OPTIONS" );
   ...
   public static  class Gxep_create_servidortemporarioparm
   {
      public String  DadosServidor ;
   ...
   @jakarta.ws.rs.Consumes({jakarta.ws.rs.core.MediaType.APPLICATION_JSON})
   @jakarta.ws.rs.Produces({jakarta.ws.rs.core.MediaType.APPLICATION_JSON + ";charset=UTF-8"})
   public jakarta.ws.rs.core.Response gxep_create_servidortemporario( crud_servidor_create_servidortemporario_RESTInterfaceIN gxep_create_servidortemporarioparm ) throws Exception
   {
      super.init( "POST" );
      permissionPrefix = "";
      if ( ! isAuthenticated(myServletRequestWrapper) )
      ...
      SdtsdtServidor AV7DadosServidor = new SdtsdtServidor(remoteHandle, context);
      AV7DadosServidor = (SdtsdtServidor)gxep_create_servidortemporarioparm.getDadosServidor().getSdt();
      String AV10DataAdmissao;
      AV10DataAdmissao = gxep_create_servidortemporarioparm.getDataAdmissao() ;
      String AV11DataDemissao;
      AV11DataDemissao = gxep_create_servidortemporarioparm.getDataDemissao() ;
      @SuppressWarnings("unchecked")
      GXBaseCollection<com.genexus.SdtMessages_Message> [] AV6Messages = new GXBaseCollection[] { new GXBaseCollection<com.genexus.SdtMessages_Message>() };
      try
      {
         crud_servidor worker = new crud_servidor(remoteHandle, context);
         worker.gxep_create_servidortemporario(AV7DadosServidor,AV10DataAdmissao,AV11DataDemissao,AV6Messages );
         crud_servidor_create_servidortemporario_RESTInterfaceOUT data = new crud_servidor_create_servidortemporario_RESTInterfaceOUT();
         data.setMessages(SdtMessages_Message_RESTInterfacefromGXObjectCollection(AV6Messages[0]));
         builder = Response.okWrapped(data);
         if ( worker.getrestcode() != 0 )
         {
   ...
   @jakarta.ws.rs.OPTIONS
   @jakarta.ws.rs.Produces({jakarta.ws.rs.core.MediaType.APPLICATION_JSON + ";charset=UTF-8"})
   public jakarta.ws.rs.core.Response GetOptionsCreate_ServidorTemporario( ) throws Exception
   {
      super.init( "OPTIONS" );
      builder = Response.options("OPTIONS,HEAD,POST");
      return (jakarta.ws.rs.core.Response) builder.build() ;
   ...
   @jakarta.ws.rs.GET
   @jakarta.ws.rs.Produces({jakarta.ws.rs.core.MediaType.APPLICATION_JSON + ";charset=UTF-8"})
   public jakarta.ws.rs.core.Response gxep_read_getbykey( @jakarta.ws.rs.QueryParam("Codgpessoa") @jakarta.ws.rs.DefaultValue("") String sAV26CodgPessoa ) throws Exception
   {
      super.init( "GET" );
      permissionPrefix = "";
      if ( ! isAuthenticated(myServletRequestWrapper) )
      ...
      AV26CodgPessoa = (short)(GXutil.lval( sAV26CodgPessoa)) ;
      SdtsdtListaServidor [] AV27ListaServidor = new SdtsdtListaServidor[] { new SdtsdtListaServidor() };
      @SuppressWarnings("unchecked")
      GXBaseCollection<com.genexus.SdtMessages_Message> [] AV6Messages = new GXBaseCollection[] { new GXBaseCollection<com.genexus.SdtMessages_Message>() };
      try
      {
         crud_servidor worker = new crud_servidor(remoteHandle, context);
         worker.gxep_read_getbykey(AV26CodgPessoa,AV27ListaServidor,AV6Messages );
         crud_servidor_read_getbykey_RESTInterfaceOUT data = new crud_servidor_read_getbykey_RESTInterfaceOUT();
         if ( AV27ListaServidor[0].isNull() == 0 )
         {
            data.setListaServidor(new SdtsdtListaServidor_RESTInterface(AV27ListaServidor[0]));
         }
         data.setMessages(SdtMessages_Message_RESTInterfacefromGXObjectCollection(AV6Messages[0]));
         builder = Response.okWrapped(data);
         if ( worker.getrestcode() != 0 )
   ...
   public static  class Gxep_update_demissaoservidortemporarioparm
   {
      public String  CodgPessoa ;
      public String  DataAdmissao ;
      public String  DataDemissao ;
   }

   @jakarta.ws.rs.Path("/{update_demissaoservidortemporario :(?i)update_demissaoservidortemporario}")
   @jakarta.ws.rs.PUT
   @jakarta.ws.rs.Consumes({jakarta.ws.rs.core.MediaType.APPLICATION_JSON})
   @jakarta.ws.rs.Produces({jakarta.ws.rs.core.MediaType.APPLICATION_JSON + ";charset=UTF-8"})
   public jakarta.ws.rs.core.Response gxep_update_demissaoservidortemporario( crud_servidor_update_demissaoservidortemporario_RESTInterfaceIN gxep_update_demissaoservidortemporarioparm ) throws Exception
   {
      super.init( "PUT" );
      permissionPrefix = "";
      if ( ! isAuthenticated(myServletRequestWrapper) )
      ...
      short AV26CodgPessoa;
      AV26CodgPessoa = gxep_update_demissaoservidortemporarioparm.getCodgPessoa() ;
      String AV10DataAdmissao;
      AV10DataAdmissao = gxep_update_demissaoservidortemporarioparm.getDataAdmissao() ;
      String AV11DataDemissao;
      AV11DataDemissao = gxep_update_demissaoservidortemporarioparm.getDataDemissao() ;
      @SuppressWarnings("unchecked")
      GXBaseCollection<com.genexus.SdtMessages_Message> [] AV6Messages = new GXBaseCollection[] { new GXBaseCollection<com.genexus.SdtMessages_Message>() };
      try
      {
         crud_servidor worker = new crud_servidor(remoteHandle, context);
         worker.gxep_update_demissaoservidortemporario(AV26CodgPessoa,AV10DataAdmissao,AV11DataDemissao,AV6Messages );
         crud_servidor_update_demissaoservidortemporario_RESTInterfaceOUT data = new crud_servidor_update_demissaoservidortemporario_RESTInterfaceOUT();
         data.setMessages(SdtMessages_Message_RESTInterfacefromGXObjectCollection(AV6Messages[0]));
         builder = Response.okWrapped(data);
         if ( worker.getrestcode() != 0 )
         {
   ...
   @jakarta.ws.rs.OPTIONS
   @jakarta.ws.rs.Produces({jakarta.ws.rs.core.MediaType.APPLICATION_JSON + ";charset=UTF-8"})
   public jakarta.ws.rs.core.Response GetOptionsUpdate_DemissaoServidorTemporario( ) throws Exception
   {
      super.init( "OPTIONS" );
