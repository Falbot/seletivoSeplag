...
@jakarta.xml.bind.annotation.XmlType(name = "sdtEnderecoLotacaoEfetivo.sdtEnderecoLotacaoEfetivoItem", namespace ="SeletivoSEPLAG", propOrder={"end_tipo_logradouro", "end_logradouro", "end_numero", "end_bairro", "cid_nome", "cid_uf", "pes_nome", "unid_nome", "unid_sigla"})
