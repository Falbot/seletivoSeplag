...
public final  class StructSdtsdtEnderecoLotacaoEfetivo_sdtEnderecoLotacaoEfetivoItem implements Cloneable, java.io.Serializable
{
   public StructSdtsdtEnderecoLotacaoEfetivo_sdtEnderecoLotacaoEfetivoItem( )
   {
      this( -1, new ModelContext( StructSdtsdtEnderecoLotacaoEfetivo_sdtEnderecoLotacaoEfetivoItem.class ));
   }

   public StructSdtsdtEnderecoLotacaoEfetivo_sdtEnderecoLotacaoEfetivoItem( int remoteHandle ,
