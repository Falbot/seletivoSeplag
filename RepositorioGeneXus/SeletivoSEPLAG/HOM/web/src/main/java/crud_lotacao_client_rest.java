...
public final  class crud_lotacao_client_rest extends GXProcedure
{
   public crud_lotacao_client_rest( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( crud_lotacao_client_rest.class ), "" );
      initialize();
   ...
   public void InitLocation( )
   {
      ...
      restLocation.setBaseURL( "SeletivoSEPLAGHOM/lotacao" );
      gxProperties = new com.genexus.properties.GXObjectProperties() ;
   }
   ...
   public void gxep_create( SdtsdtLotacaoV2 in_AV6DadosLotacao ,
                            GXBaseCollection<com.genexus.SdtMessages_Message> [] arr_AV5Messages )
   {
      ...
      restCliCreate.addBodyVar("DadosLotacao", in_AV6DadosLotacao);
      ...
      {
         arr_AV5Messages[0] = restCliCreate.getBodyObjCollection("Messages",com.genexus.SdtMessages_Message.class );
      }
      /* Create Constructor */
   }
                                  ...
                                  GXBaseCollection<SdtsdtListaLotacoes_sdtListaLotacoesItem> [] arr_AV8ListaDadosLotacao )
   {
      ...
      restCliRead_GetList.addQueryVar("Pagenumber", in_AV17PageNumber);
      restCliRead_GetList.addQueryVar("Pagesize", in_AV18PageSize);
      ...
      {
         arr_AV8ListaDadosLotacao[0] = restCliRead_GetList.getBodyObjCollection("ListaDadosLotacao",SdtsdtListaLotacoes_sdtListaLotacoesItem.class );
      }
                                   ...
                                   GXBaseCollection<com.genexus.SdtMessages_Message> [] arr_AV5Messages )
   {
      ...
      restCliRead_GetByKey.addQueryVar("Codglotacao", in_AV9codgLotacao);
      ...
      {
         arr_AV11ListaLotacao[0] = restCliRead_GetByKey.getBodyObj("ListaLotacao",SdtsdtListaLotacao.class );
         arr_AV5Messages[0] = restCliRead_GetByKey.getBodyObjCollection("Messages",com.genexus.SdtMessages_Message.class );
      }
      /* Read_GetByKey Constructor */
   }

   public void gxep_update( short in_AV9codgLotacao ,
                            ...
                            GXBaseCollection<com.genexus.SdtMessages_Message> [] arr_AV5Messages )
   {
      ...
      restCliUpdate.addBodyVar("codgLotacao", in_AV9codgLotacao);
      restCliUpdate.addBodyVar("InfoLotacao", in_AV12InfoLotacao);
      ...
      {
         arr_AV5Messages[0] = restCliUpdate.getBodyObjCollection("Messages",com.genexus.SdtMessages_Message.class );
      }
      /* Update Constructor */
   }

   public void gxep_delete( short in_AV9codgLotacao ,
                            GXBaseCollection<com.genexus.SdtMessages_Message> [] arr_AV5Messages )
   {
      ...
      restCliDelete.addQueryVar("Codglotacao", in_AV9codgLotacao);
      ...
      {
         arr_AV5Messages[0] = restCliDelete.getBodyObjCollection("Messages",com.genexus.SdtMessages_Message.class );
      }
      /* Delete Constructor */
   }
