...
public final  class SdtsdtListaPessoa extends GxUserType
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("pes_nome", gxTv_SdtsdtListaPessoa_Pes_nome);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("pes_data_nascimento", gxTv_SdtsdtListaPessoa_Pes_data_nascimento);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("pes_sexo", gxTv_SdtsdtListaPessoa_Pes_sexo);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("pes_mae", gxTv_SdtsdtListaPessoa_Pes_mae);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("pes_pai", gxTv_SdtsdtListaPessoa_Pes_pai);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
