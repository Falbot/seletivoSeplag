...
public final  class SdtsdtListaUnidades_sdtListaUnidadesItem extends GxUserType
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("unid_nome", gxTv_SdtsdtListaUnidades_sdtListaUnidadesItem_Unid_nome);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("unid_sigla", gxTv_SdtsdtListaUnidades_sdtListaUnidadesItem_Unid_sigla);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
