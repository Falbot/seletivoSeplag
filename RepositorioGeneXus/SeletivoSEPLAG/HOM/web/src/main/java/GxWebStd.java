...
public final  class GxWebStd
{
                                           ...
                                           String sCallerPgm )
   {
      ...
      if ( nEnabled == 0 )
      {
         ...
         if ( nFormat != 2 )
         {
            ...
            GxWebStd.gx_start_js_anchor( httpContext, nJScriptCode, sEventJsCode, sUserOnClickCode, sLinkURL, sLinkTarget, "");
         }
         if ( nIsPassword == 0 )
         {
            if ( nFormat == 0 )
                                      ...
                                      String sCallerPgm )
   {
      ...
      GxWebStd.gx_on_js_event( httpContext, nJScriptCode, sEventJsCode, sUserOnClickCode);
      httpContext.writeText( " ") ;
      httpContext.writeText( sTags) ;
      httpContext.writeText( httpContext.htmlEndTag( HTMLElement.INPUT)) ;
      if ( GXutil.strcmp(sBorderStyle, "rounded") == 0 )
                                         ...
                                         String sCallerPgm )
   {
      ...
      GxWebStd.classAttribute( httpContext, sClassString);
      GxWebStd.styleAttribute( httpContext, sStyleString);
      GxWebStd.gx_ctrl_attribute( httpContext, sCtrlName, "data-jsevent", sUserOnClickCode, false, false);
      GxWebStd.gx_ctrl_attribute( httpContext, sCtrlName, "data-gxoch0", sEventJsCode, true, false);
      httpContext.writeText( sTags) ;
                                          ...
                                          String sImgSrcSet )
   {
      ...
      {
         GxWebStd.gx_start_js_anchor( httpContext, nJScriptCode, sEventJsCode, sUserOnClickCode, sLinkURL, sLinkTarget, "gx-image-link");
      }
      if ( GXutil.strcmp(GXutil.substring( sImageURL, 1, 11), "gx-image://") == 0 )
      {
         httpContext.writeText( "<img ") ;
                                                ...
                                                String sCallerPgm )
   {
      ...
      GxWebStd.gx_single_line_edit( httpContext, sInternalName+"_GXI", sURL, sURL, sInputTags, sEventName, "", "", sTooltipText, "", sUserOnClickCode, 0, "field "+sClassString, sStyleString, "", "", "", 1, 1, 1, "text", "", nWidth, nWidthUnit, nHeight, nHeightUnit, 254, (byte)(0), (short)(2), 0, (byte)(1), (byte)(1), (byte)(0), true, "", sAlign, false, "", sCallerPgm);
                               ...
                               String sCallerPgm )
   {
      ...
      if ( ( nReadOnly == 0 ) && ( nEnabled == 1 ) )
      {
         GxWebStd.gx_multimedia_upload_end( httpContext, sInternalName, sMultimediaURL, "", nWidth, nWidthUnit, nHeight, nHeightUnit, sUserOnClickCode, sEventName, sStyleString, sClassString, "", "", "", sInputTags, nReadOnly, bIsBlob, "*", sCallerPgm);
      }
   }
                                          ...
                                          String sClassString )
   {
      ...
      else
      {
         ...
         {
            GxWebStd.gx_link_start( httpContext, sLinkURL, sLinkTarget, sClassString);
         }
      }
   }
                                        ...
                                        String sExtraStyle )
   {
      ...
      {
         GxWebStd.styleAttribute( httpContext, GXutil.CssPrettify( sExtraStyle));
      }
      httpContext.writeText( ">") ;
                                        ...
                                        String sCallerPgm )
   {
      ...
      GxWebStd.gx_ctrl_attribute( httpContext, sCtrlName, "maxlength", sLength, false, true);
      httpContext.writeTextNL( ">") ;
      httpContext.writeValue( sValue) ;
      ...
      if ( nEnabled == 0 )
      {
         ...
         GxWebStd.gx_start_js_anchor( httpContext, nJScriptCode, sEventJsCode, "", sLinkURL, sLinkTarget, "");
         if ( nFormat == 0 )
         {
         ...
         GxWebStd.gx_end_js_anchor( httpContext, sEventJsCode, "", sLinkURL);
         httpContext.writeText( "</span>") ;
      }
   }
                                      ...
                                      String rtPicture )
   {
      ...
      GxWebStd.gx_single_line_edit( httpContext, sCtrlName, sValue, sFormatedValue, sTagsLocal, sEventName, sLinkURL, sLinkTarget, sTooltipText, sPlaceholder, sUserOnClickCode, nJScriptCode, sClassString, sStyleString, sROClassString, sColumnClassString, sColumnHeaderClassString, nVisible, nEnabled, nRTEnabled, sType, sStep, nWidth, nWidthUnit, nHeight, nHeightUnit, nLength, nIsPassword, nFormat, nParentId, bHasTheme, nAutoComplete, nAutoCorrection, bSendHidden, sDomainType, "", false, "", "");
