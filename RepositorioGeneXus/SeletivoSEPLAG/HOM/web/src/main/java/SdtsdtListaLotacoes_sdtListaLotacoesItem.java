...
public final  class SdtsdtListaLotacoes_sdtListaLotacoesItem extends GxUserType
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("pes_nome", gxTv_SdtsdtListaLotacoes_sdtListaLotacoesItem_Pes_nome);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      ...
      oWriter.writeElement("unid_nome", gxTv_SdtsdtListaLotacoes_sdtListaLotacoesItem_Unid_nome);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("unid_sigla", gxTv_SdtsdtListaLotacoes_sdtListaLotacoesItem_Unid_sigla);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      ...
      oWriter.writeElement("lot_portaria", gxTv_SdtsdtListaLotacoes_sdtListaLotacoesItem_Lot_portaria);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
