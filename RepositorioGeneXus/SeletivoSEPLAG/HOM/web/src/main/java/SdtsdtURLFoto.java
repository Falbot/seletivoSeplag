...
public final  class SdtsdtURLFoto extends GxUserType
{
                         ...
                         String sName )
   {
      ...
      if ( oReader.getIsSimple() == 0 )
      {
         ...
         while ( ( ( GXutil.strcmp(oReader.getName(), sTagName) != 0 ) || ( oReader.getNodeType() == 1 ) ) && ( GXSoapError > 0 ) )
         {
            ...
            {
               gxTv_SdtsdtURLFoto_Fp_id = (short)(getnumericvalue(oReader.getValue())) ;
               readElement = true ;
               if ( GXSoapError > 0 )
               {
                  readOk = (short)(1) ;
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("LinkExp5Minutos", gxTv_SdtsdtURLFoto_Linkexp5minutos);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("fp_id", GXutil.trim( GXutil.str( gxTv_SdtsdtURLFoto_Fp_id, 4, 0)));
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
                       ...
                       boolean includeNonInitialized )
   {
      ...
      AddObjectProperty("fp_id", gxTv_SdtsdtURLFoto_Fp_id, false, false);
   }
   ...
   public void setStruct( StructSdtsdtURLFoto struct )
   {
      if ( struct != null )
      {
         ...
         setgxTv_SdtsdtURLFoto_Fp_id(struct.getFp_id());
      }
   }
   ...
   public StructSdtsdtURLFoto getStruct( )
   {
      ...
      struct.setFp_id(getgxTv_SdtsdtURLFoto_Fp_id());
      return struct ;
   }
