...
public final  class SdtsdtListaUnidade extends GxUserType
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("unid_nome", gxTv_SdtsdtListaUnidade_Unid_nome);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("unid_sigla", gxTv_SdtsdtListaUnidade_Unid_sigla);
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
