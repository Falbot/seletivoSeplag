...
public final  class rwdrecentlinks_impl extends GXWebComponent
{
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      GxWebStd.gx_hidden_field( httpContext, sPrefix+"nRC_GXsfl_8", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_8, (byte)(8), (byte)(0), ",", "")));
      ...
      GxWebStd.gx_hidden_field( httpContext, sPrefix+"subLinks_Recordcount", GXutil.ltrim( localUtil.ntoc( subLinks_Recordcount, (byte)(5), (byte)(0), ",", "")));
      GxWebStd.gx_hidden_field( httpContext, sPrefix+"MAINTABLE_Class", GXutil.rtrim( divMaintable_Class));
   }
   ...
   public void wb050( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         GxWebStd.gx_div_start( httpContext, divMaintable_Internalname, 1, 0, "px", 0, "px", divMaintable_Class, "start", "top", "", "", "div");
         /* Div Control */
         GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         /* Div Control */
         GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-2 col-md-1", "start", "top", "", "", "div");
         /* Text block */
         GxWebStd.gx_label_ctrl( httpContext, lblRecenttext_Internalname, "Recents", "", "", lblRecenttext_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e11051_client"+"'", "", "RecentsTitle", 7, "", 1, 1, 0, (short)(0), "HLP_RwdRecentLinks.htm");
         GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-10 col-md-11", "start", "top", "", "", "div");
         /*  Grid Control  */
   ...
   public void strup050( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         subLinks_Recordcount = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"subLinks_Recordcount"), ",", ".")) ;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20254523212224", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("rwdrecentlinks.js", "?20254523212224", false, true);
   ...
   public void sendrow_82( )
   {
      ...
      /* Div Control */
      LinksRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {divLinkstable_Internalname+"_"+sGXsfl_8_idx,Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","RecentLinksTable","start","top","","","div"});
      /* Div Control */
      LinksRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","row","start","top","","","div"});
      /* Div Control */
      LinksRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {"",Integer.valueOf(1),Integer.valueOf(0),"px",Integer.valueOf(0),"px","col-xs-12","start","top","","","div"});
      /* Text block */
      ...
      LinksRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {"start","top","div"});
      LinksRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {"start","top","div"});
      LinksRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {"start","top","div"});
   ...
   private int subLinks_Recordcount ;
