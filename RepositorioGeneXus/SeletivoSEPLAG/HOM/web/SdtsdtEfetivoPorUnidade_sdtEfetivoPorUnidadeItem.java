...
public final  class SdtsdtEfetivoPorUnidade_sdtEfetivoPorUnidadeItem extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("pes_nome", GXutil.rtrim( gxTv_SdtsdtEfetivoPorUnidade_sdtEfetivoPorUnidadeItem_Pes_nome));
      ...
      oWriter.writeElement("unid_nome", GXutil.rtrim( gxTv_SdtsdtEfetivoPorUnidade_sdtEfetivoPorUnidadeItem_Unid_nome));
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("unid_sigla", GXutil.rtrim( gxTv_SdtsdtEfetivoPorUnidade_sdtEfetivoPorUnidadeItem_Unid_sigla));
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
   ...
   public void initialize( )
   {
      ...
      gxTv_SdtsdtEfetivoPorUnidade_sdtEfetivoPorUnidadeItem_N = (byte)(1) ;
   ...
   public byte isNull( )
   {
      return gxTv_SdtsdtEfetivoPorUnidade_sdtEfetivoPorUnidadeItem_N ;
   }
