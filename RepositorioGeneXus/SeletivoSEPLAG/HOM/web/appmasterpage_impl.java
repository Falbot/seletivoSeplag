...
public final  class appmasterpage_impl extends GXMasterPage
{
   ...
   public void renderHtmlCloseForm012( )
   {
      ...
      httpContext.AddJavascriptSource("appmasterpage.js", "?20254215304255", false, true);
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( (getDataAreaObject() == null ? Form : getDataAreaObject().getForm()).getJscriptsrc().item(idxLst)), "?20254215304273", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   {
      httpContext.AddJavascriptSource("appmasterpage.js", "?20254215304274", false, true);
