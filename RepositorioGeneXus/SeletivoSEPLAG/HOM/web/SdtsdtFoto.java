...
public final  class SdtsdtFoto extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
   public SdtsdtFoto( )
   {
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("arquivoBase64", GXutil.rtrim( gxTv_SdtsdtFoto_Arquivobase64));
   ...
   public void initialize( )
   {
      ...
      gxTv_SdtsdtFoto_N = (byte)(1) ;
      sTagName = "" ;
   }

   public byte isNull( )
   {
      return gxTv_SdtsdtFoto_N ;
   }
