...
public final  class SdtsdtCidade extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
   public SdtsdtCidade( )
   {
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("cid_nome", GXutil.rtrim( gxTv_SdtsdtCidade_Cid_nome));
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("cid_uf", GXutil.rtrim( gxTv_SdtsdtCidade_Cid_uf));
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
   ...
   protected byte gxTv_SdtsdtCidade_N ;
