...
public final  class Sdtendereco extends GxSilentTrnSdt implements Cloneable, java.io.Serializable
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("end_tipo_logradouro", GXutil.rtrim( gxTv_Sdtendereco_End_tipo_logradouro));
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("end_logradouro", GXutil.rtrim( gxTv_Sdtendereco_End_logradouro));
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      ...
      oWriter.writeElement("end_bairro", GXutil.rtrim( gxTv_Sdtendereco_End_bairro));
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      ...
      oWriter.writeElement("cid_nome", GXutil.rtrim( gxTv_Sdtendereco_Cid_nome));
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("cid_uf", GXutil.rtrim( gxTv_Sdtendereco_Cid_uf));
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      if ( sIncludeState )
      {
         oWriter.writeElement("Mode", GXutil.rtrim( gxTv_Sdtendereco_Mode));
         if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
         {
            oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
         }
         ...
         oWriter.writeElement("end_tipo_logradouro_Z", GXutil.rtrim( gxTv_Sdtendereco_End_tipo_logradouro_Z));
         if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
         {
            oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
         }
         oWriter.writeElement("end_logradouro_Z", GXutil.rtrim( gxTv_Sdtendereco_End_logradouro_Z));
         if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
         {
            oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
         }
         ...
         oWriter.writeElement("end_bairro_Z", GXutil.rtrim( gxTv_Sdtendereco_End_bairro_Z));
         if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
         {
            oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
         }
         ...
         oWriter.writeElement("cid_nome_Z", GXutil.rtrim( gxTv_Sdtendereco_Cid_nome_Z));
         if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
         {
            oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
         }
         oWriter.writeElement("cid_uf_Z", GXutil.rtrim( gxTv_Sdtendereco_Cid_uf_Z));
         if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
         {
            oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
         }
   ...
   private byte gxTv_Sdtendereco_N ;
