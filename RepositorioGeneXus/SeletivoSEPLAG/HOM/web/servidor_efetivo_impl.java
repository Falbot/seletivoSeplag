...
public final  class servidor_efetivo_impl extends GXDataArea
{
   ...
   public void drawControls( )
   {
      ...
      GxWebStd.gx_single_line_edit( httpContext, edtpes_id_Internalname, GXutil.ltrim( localUtil.ntoc( A7pes_id, (byte)(4), (byte)(0), ",", "")), GXutil.ltrim( ((edtpes_id_Enabled!=0) ? localUtil.format( DecimalUtil.doubleToDec(A7pes_id), "ZZZ9") : localUtil.format( DecimalUtil.doubleToDec(A7pes_id), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtpes_id_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtpes_id_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "", "HLP_servidor_efetivo.htm");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      /* Div Control */
      GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtse_matricula_Internalname+"\"", "", "div");
      /* Attribute/Variable Label */
      ...
      GxWebStd.gx_single_line_edit( httpContext, edtse_matricula_Internalname, A26se_matricula, GXutil.rtrim( localUtil.format( A26se_matricula, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtse_matricula_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtse_matricula_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "", "HLP_servidor_efetivo.htm");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20254215303898", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025421530390", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("servidor_efetivo.js", "?2025421530390", false, true);
