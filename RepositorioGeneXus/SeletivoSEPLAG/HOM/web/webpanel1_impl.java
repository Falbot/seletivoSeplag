...
public final  class webpanel1_impl extends GXDataArea
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20254215304293", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
   ...
   public void wb070( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         GxWebStd.gx_div_start( httpContext, divMaintable_Internalname, 1, 0, "px", 0, "px", "Table", "left", "top", "", "", "div");
         /* Div Control */
   ...
   public void e11072( )
   {
      ...
      AV6Properties.set("STORAGE_CUSTOM_ENDPOINT", "http://minio:9001");
      GXv_storageprovider1[0] = AV7StorageProvider ;
      GXv_objcol_SdtMessages_Message2[0] = AV8Messages ;
      if ( AV5ExternalStorage.connect("Default", AV6Properties, GXv_storageprovider1, GXv_objcol_SdtMessages_Message2) )
      {
         AV7StorageProvider = GXv_storageprovider1[0] ;
         ...
         AV12File.setSource( "D:\\Mestrado\\MPA003\\TarefaComAutoria.JPG" );
         ...
         {
            AV20GXV1 = 1 ;
            while ( AV20GXV1 <= AV8Messages.size() )
            {
               AV14Message = (com.genexus.SdtMessages_Message)((com.genexus.SdtMessages_Message)AV8Messages.elementAt(-1+AV20GXV1));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2025421530435", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("webpanel1.js", "?2025421530435", false, true);
