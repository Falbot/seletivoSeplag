...
public final  class promptmasterpage_impl extends GXMasterPage
{
   ...
   public void renderHtmlCloseForm032( )
   {
      ...
      httpContext.AddJavascriptSource("promptmasterpage.js", "?20254215304236", false, true);
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( (getDataAreaObject() == null ? Form : getDataAreaObject().getForm()).getJscriptsrc().item(idxLst)), "?20254215304245", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("promptmasterpage.js", "?20254215304245", false, true);
      }
