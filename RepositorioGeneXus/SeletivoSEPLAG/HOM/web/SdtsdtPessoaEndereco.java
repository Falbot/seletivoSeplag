...
public final  class SdtsdtPessoaEndereco extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
   ...
   {
      gxTv_SdtsdtPessoaEndereco_N = (byte)(0) ;
   ...
   {
      gxTv_SdtsdtPessoaEndereco_N = (byte)(1) ;
      sTagName = "" ;
   }

   public byte isNull( )
   {
      return gxTv_SdtsdtPessoaEndereco_N ;
   }
   ...
   protected byte gxTv_SdtsdtPessoaEndereco_N ;
