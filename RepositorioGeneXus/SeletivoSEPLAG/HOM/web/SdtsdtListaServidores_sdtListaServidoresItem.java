...
public final  class SdtsdtListaServidores_sdtListaServidoresItem extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("pes_nome", GXutil.rtrim( gxTv_SdtsdtListaServidores_sdtListaServidoresItem_Pes_nome));
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      ...
      oWriter.writeElement("pes_sexo", GXutil.rtrim( gxTv_SdtsdtListaServidores_sdtListaServidoresItem_Pes_sexo));
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("unid_nome", GXutil.rtrim( gxTv_SdtsdtListaServidores_sdtListaServidoresItem_Unid_nome));
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("unid_sigla", GXutil.rtrim( gxTv_SdtsdtListaServidores_sdtListaServidoresItem_Unid_sigla));
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      ...
      oWriter.writeElement("lot_portaria", GXutil.rtrim( gxTv_SdtsdtListaServidores_sdtListaServidoresItem_Lot_portaria));
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("TipoServidor", GXutil.rtrim( gxTv_SdtsdtListaServidores_sdtListaServidoresItem_Tiposervidor));
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
   ...
   {
      gxTv_SdtsdtListaServidores_sdtListaServidoresItem_N = (byte)(0) ;
   ...
   {
      gxTv_SdtsdtListaServidores_sdtListaServidoresItem_N = (byte)(1) ;
   ...
   public byte isNull( )
   {
      return gxTv_SdtsdtListaServidores_sdtListaServidoresItem_N ;
   }
   ...
   protected byte gxTv_SdtsdtListaServidores_sdtListaServidoresItem_N ;
