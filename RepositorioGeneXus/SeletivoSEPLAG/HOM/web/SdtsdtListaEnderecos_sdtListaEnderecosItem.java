...
public final  class SdtsdtListaEnderecos_sdtListaEnderecosItem extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("end_tipo_logradouro", GXutil.rtrim( gxTv_SdtsdtListaEnderecos_sdtListaEnderecosItem_End_tipo_logradouro));
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("end_logradouro", GXutil.rtrim( gxTv_SdtsdtListaEnderecos_sdtListaEnderecosItem_End_logradouro));
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      ...
      oWriter.writeElement("end_bairro", GXutil.rtrim( gxTv_SdtsdtListaEnderecos_sdtListaEnderecosItem_End_bairro));
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      ...
      oWriter.writeElement("cid_nome", GXutil.rtrim( gxTv_SdtsdtListaEnderecos_sdtListaEnderecosItem_Cid_nome));
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
      oWriter.writeElement("cid_uf", GXutil.rtrim( gxTv_SdtsdtListaEnderecos_sdtListaEnderecosItem_Cid_uf));
      if ( GXutil.strcmp(sNameSpace, "SeletivoSEPLAG") != 0 )
      {
         oWriter.writeAttribute("xmlns", "SeletivoSEPLAG");
      }
   ...
   {
      gxTv_SdtsdtListaEnderecos_sdtListaEnderecosItem_N = (byte)(0) ;
   ...
   {
      gxTv_SdtsdtListaEnderecos_sdtListaEnderecosItem_N = (byte)(1) ;
   ...
   public byte isNull( )
   {
      return gxTv_SdtsdtListaEnderecos_sdtListaEnderecosItem_N ;
   }
   ...
   protected byte gxTv_SdtsdtListaEnderecos_sdtListaEnderecosItem_N ;
